...
module.exports = {
  // Node.js app
  port: process.env.BED_PORT || 2083,
  host: process.env.BED_HOST || 'http://localhost:2083',
  gatewayHost:
    process.env.API_GATEWAY_HOST ||
    `http://localhost:${process.env.BED_PORT || 2083}`,
  ...
  platformName: process.env.PLATFORM_NAME || 'IXP',
  ...
  databaseUrl:
    ...
    `mysql://${process.env.DB_USER || 'root'}:${process.env.DB_PASS ||
      ...
      '3306'}/${process.env.DB_NAME || 'nydax'}`,
