...
export const initialize = async () => {
  ...
  console.warn("Db initialize started");
  ...
  const data = [
    ...
    },
    {
      ...
      password: bcrypt.hashSync(`Ronnie@123`, bcrypt.genSaltSync(8), null),
      emailConfirmed: true,
      isBot: true,
      isExchange: true,
    },
    {
      id: 1111,
      email: `ronniegandhi19999@gmail.com`,
      password: bcrypt.hashSync(`Ronnie@123`, bcrypt.genSaltSync(8), null),
      emailConfirmed: true,
      isBot: true,
      isExchange: true,
  ...
  console.warn("Db initialize...."+data+"....ready");
  ...
  console.warn("Db initialize request sent");
  ...
  console.warn("Db initialize complete");
};
