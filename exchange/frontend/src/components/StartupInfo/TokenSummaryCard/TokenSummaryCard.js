  ...
  <div className={themify(s, s.root, theme)}>
    ...
    <div className={s.body}>
      <div className={s.statistics}>
        <p className={s.statisticTitle}>Number of sold stacks</p>
        <p className={s.statistic}>{soldTokens}</p>
      </div>
      <div className={s.statistics}>
        <p className={s.statisticTitle}>Total stacks amount</p>
      ...
      >
        <div style={{ padding: 5 }}>Buy {tokenSymbol} stack instantly</div>
      </Button>
