...
import invoLogo from '../../../public/logo/xsym_c.png';
...
const startupsInfo = [
  {
    ...
    summary: {
      tokenLogo: invoLogo,
      tokenSymbol: 'X',
      companyName: 'Xeldorado',
      companyDescription: 'Cartoon Graphic designer',
      price: '$1111',
      soldTokens: 495.7826541,
      totalTokenAmount: 888800,
    },
    videoPlayer: {
      url: 'https://www.youtube.com/watch?v=Ci3PoUjtBOE',
    },
    aboutUs: {
      description: `Welcome to a journey through my creative process and personal projects I did in April of 2021.
      Exploring different techniques, colors and materials to create visually pleasing compositions.`,
      location: 'Sydney, NSW, Australia',
      founders: 'Melon Eusk',
      dateFounded: 'Aug 18, 2021',
      website: 'https://nft.xeldorado.live/',
      facebook: 'http://www.facebook.com',
      linkedin: 'http://www.linkedin.com',
      twitter: 'http://www.twitter.com',
      contactEmail: 'contact@xeldorado.net',
      phoneNumber: '(461)849-566',
    },
    teamMembers: {
      description: `Xeldorado has 7 advisors, and besides the Creator.`,
      members: [
        {
